...
public class BluetoothLeService extends Service {
    ...
    //ring buffer
    private final RingBuffer<BluetoothGattCharacteristicHelper> mCharacteristicRingBuffer = new RingBuffer<BluetoothGattCharacteristicHelper>(8);
...
//        }
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        String writeCharacteristicString = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            writeCharacteristicString = new String(characteristic.getValue(), StandardCharsets.ISO_8859_1);
        }
