...
//	}
    ...
    protected abstract void onConectionStateChange(connectionStateEnum theconnectionStateEnum);
...
//            mHandler.postDelayed(mDisonnectingOverTimeRunnable, 10000);
    ...
    void onActivityResultProcess(int requestCode, int resultCode, Intent data) {
...
//                    updateConnectionState(R.string.comm_establish);
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = mInflator.inflate(R.layout.activity_bluno_library, null);
